class StaticPagesController < ApplicationController
	...
	def product_status
		...
		alldonet_user_prod = JSON.load(open("https://trm-dot-alldonetutils.appspot.com/c/asterism/revokeuser/?aid=#{current_user.id}&pk=none&u=asterismui&pw=foobar"))
		...
		@approved_prod = []
		if !alldonet_user_prod['urls'].nil?
			alldonet_user_prod['urls'].each do |url|
